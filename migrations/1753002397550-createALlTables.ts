...
export class CreateALlTables1753002397550 implements MigrationInterface {
    name = 'CreateALlTables1753002397550'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "file_upload" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "originalName" character varying(255) NOT NULL, "filename" character varying(255) NOT NULL, "path" character varying(500) NOT NULL, "mimetype" character varying(100) NOT NULL, "size" bigint NOT NULL, "extension" character varying(10) NOT NULL, "fileType" "public"."file_upload_filetype_enum" NOT NULL DEFAULT 'other', "description" character varying(255), "isPublic" boolean NOT NULL DEFAULT false, "url" character varying(255), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_bb8460e39fcad3aaa44d1d7e5d3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_file" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "file_id" uuid NOT NULL, "user_id" uuid NOT NULL, "file_type" character varying(255) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_c6771f226a8149de690641d11ae" PRIMARY KEY ("id"))`);
